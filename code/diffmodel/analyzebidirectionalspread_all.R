...
save(df,c.Grp.antero,c.Grp.retro,Xt.sweep.retro,Xt.sweep.antero,file = paste(savedir,'all_mice_BidirectionalFit_data.RData',sep=''))
save(c.Grp.antero,c.Grp.retro,file = paste(savedir,'all_mice_IndependentBidirectionalFit_params.RData',sep=''))
