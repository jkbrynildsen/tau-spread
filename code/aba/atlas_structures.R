...
# IN PYTHON, EXECUTE:
# python /Users/jkbrynildsen/Box/PD_Project/Quant_pathology_dataset/code/aba/MakeCCFMasks.py /Users/jkbrynildsen/Box/PD_Project/Quant_pathology_dataset/ data/aba/atlas/structIDs.csv data/aba/atlas/mask_aba.mat
